...
all_injuries_url = "https://www.cbssports.com/nba/injuries/"
...
dictkeydts = {
    "2122": {
        "regseastart": datetime(2021, 10, 18, 0, 30),
    ...
    "2223": {
        "regseastart": datetime(2022, 10, 17, 0, 30),
    ...
    "2324": {
        "regseastart": datetime(2023, 10, 24, 17, 30),
    ...
    "2425": {
        "regseastart": datetime(2024, 10, 21, 0, 30),
    ...
    "2526": {
        "regseastart": datetime(2025, 10, 20, 0, 30),
